...
\cstitlerunning{Submission and Formatting Instructions for CS4437/CS9637}

\begin{document} 

\twocolumn[
\cstitle{Submission and Formatting Instructions for the Twenty-Eighth \\ 
           International Conference on Machine Learning (ICML)}

% It is OKAY to include author information
\csauthor{Your Name}{email@yourdomain.edu}
\csaddress{Your Fantastic Institute,
            314159 Pi St., Palo Alto, CA 94306 USA}

% You may provide any keywords that you 
% find helpful for describing your paper; these are used to populate 
% the "keywords" metadata in the PDF but will not be shown in the document
\cskeywords{boring formatting information, machine learning, ICML}

\vskip 0.3in
]

\begin{abstract} 
{\bf NOTE that the example text in this document is placeholder text from
  ICML. DO NOT USE IT AS A GUIDE. Replace it with your own; refer to
  the Wiki page for project report requirements.} ICML 2012
full paper submissions are due February 24, 2012. Reviewing will be
blind to the identities of the authors, and therefore identifying
information must not appear in any way in papers submitted for
...
\verb+\csauthor{...}+ to specify authors.  The author information
